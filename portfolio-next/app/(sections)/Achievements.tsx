...
export function Achievements() {
  ...
  const achievements = [
    ...
    },
    {
      ...
      description: 'Ranked in the top 25% of competitive coders during the Winter coding initiative, demonstrating exceptional problem-solving and algorithmic skills.',
      year: '2025',
