...
interface ProjectCardFlowProps {
  projects: Project[];
}

export function ProjectCardFlow({ projects }: ProjectCardFlowProps) {
  ...
  return (
    <div className="relative w-full px-4">
      ...
      <motion.button
        ...
        viewport={{ once: true }}
        className="absolute -left-6 top-1/2 -translate-y-1/2 z-10 p-2 rounded-lg bg-surface border border-white/10 hover:border-accent/50 hover:bg-surface/80 transition-all disabled:opacity-30 disabled:pointer-events-none"
      ...
      <motion.button
        ...
        whileInView={{ opacity: 1 }}
        viewport={{ once: true }}
        className="absolute -right-6 top-1/2 -translate-y-1/2 z-10 p-2 rounded-lg bg-surface border border-white/10 hover:border-accent/50 hover:bg-surface/80 transition-all disabled:opacity-30 disabled:pointer-events-none"
